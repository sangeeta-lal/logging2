...
#ExPR uses only expression of the IF condition to classify 
#==========================================================================##
import numpy as np
import pylab
import matplotlib
...
result_table = "result_if_expr_operator"
"""
port=3307
user="sangeetal"
password="sangeetal"
...
str_logged = "select    expr, logged from "+ table_if_feature +" where expr not like \
...
#======== Not Logged===========#
str_not_logged = "select   expr, logged from "+table_if_feature+" where expr not like \
'%.isDebugEnabled()' and expr not like '%.isInfoEnabled()' and expr not like '%.isTraceEnabled()'\
  and expr not like '%.isErrorEnabled()' and expr not like '%.isFatalEnabled()' and expr not like '%.isWarnEnabled()'\
