...
public class tomcat_ASTParser {
	...
	String table ="tomcat_level_feature";
   ...
   */
	...
	{				    
		tomcat_ASTParser demo = new tomcat_ASTParser();
...
public void ast_prser(String file_name)
	{
		...
		try{
			...
			rawContent = tomcat_ASTParser.readFileToString(file_name);
